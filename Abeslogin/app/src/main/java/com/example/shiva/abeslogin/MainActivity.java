package com.example.shiva.abeslogin;
...
//                read();
    ...
    public void login(String username, String password) {
        ...
        final String js = "javascript:document.getElementsByName('usernmae').value = '" + username + "';document.getElementsByName('password').value='" + password + "';";
        webView.setWebViewClient(new WebViewClient() {
